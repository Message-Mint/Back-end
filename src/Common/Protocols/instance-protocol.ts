...
export interface InstanceProtocol {
    ...
    updateInstanceById(id: string, data: Prisma.InstanceUpdateInput): Promise<InstanceEntity>;
    deleteInstanceById(id: string): Promise<InstanceEntity>;
    findActiveInstances(): Promise<{ id: string; userId: string; sessionStorage: string }[]>;
}
